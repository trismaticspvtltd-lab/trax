...
let DriversController = class DriversController {
    ...
    findOne(id) { return this.driversService.findOne(+id); }
    create(body) { return this.driversService.create(body); }
    update(id, body) { return this.driversService.update(+id, body); }
    remove(id) { return this.driversService.remove(+id); }
};
